 ...
 * <p>
 * We can use this to place some other widgets in a vertical position.
 * </p>
 */
public class VerticalPane extends Pane {
    ...
    public VerticalPane( final double width, final double height ) {
        ...
        this.nodePrefHeight = Utils.clamp( height, USE_COMPUTED_SIZE, Double.MAX_VALUE );
        this.nodePrefWidth = Utils.clamp( width, USE_COMPUTED_SIZE, PANE_MAX_WIDTH );
    ...
    public void setOffsetX( final double offset ) {
        ...
        this.xOff = Utils.clamp( offset, MIN_OFFSET, MAX_OFFSET_X );
    ...
    public void setOffsetY( final double offset ) {
        ...
        this.yOff = Utils.clamp( offset, MIN_OFFSET, MAX_OFFSET_Y );
    }
